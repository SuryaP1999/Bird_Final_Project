...
birdClassLong= ['Dendrocopos major', 'Coccothraustes coccothraustes', 'Delichon urbicum', 'Apus apus', 'Turdus pilaris', 'Passer montanus', 'Garrulus glandarius', 'Podiceps gallardoi', 'Antilophia bokermanni'] 
birdQ= ['Dendrocopos+major', 'Coccothraustes+coccothraustes', 'Delichon+urbicum', 'Apus+apus', 'Turdus+pilaris', 'Passer+montanus', 'Garrulus+glandarius', 'Podiceps+gallardoi', 'Antilophia+bokermanni'] 
...
def get_image(name):
    url = 'https://google.com/search?q='+name+"&tbm=isch"
    print(url)
    request_result=requests.get( url )
...
def upload():
    if request.method == 'POST':
        try:
            ...
            f.save(file_path) #saving to  uploads
